...
class TaskReportItem extends StatefulWidget {
  const TaskReportItem({Key? key, required this.data}) : super(key: key);

  final Map<String, String> data;
  @override
  _TaskReportItemState createState() => _TaskReportItemState();
}

class _TaskReportItemState extends State<TaskReportItem> {
  Color? stateColor;
  String textState = '';
